...
export default function DynamicMapViewerClient({ locations }: Props) {
  return (
    <div className="h-full w-full p-0 overflow-hidden relative">
      ...
      <div className="bg-background/80 absolute top-2 left-2 z-10 flex flex-wrap gap-x-3 gap-y-1 rounded px-2 py-1 font-mono text-xs backdrop-blur border border-solid border-gray-200/20 cursor-default">
        <span>
