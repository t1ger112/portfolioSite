      ...
      <div className="content-container">
        ...
        <div className="miniNavCont">
          <div className="trail-cont font-small">
            ...
            <Link className="trail-text" href="#">Portfolio</Link>  
          </div>
          <ThemeSlider />
        </div>
        ...
        <div className="section-cont content-col">
              ...
              <Link id={val.link} key={index} href={val.link} title={"View this " + val.title + " activity..."} className="section-entry-half section-minheight prefaceOrideStatic"> 
                ...
                <div className="prefaced-contents">
                  ...
                  <div className="font-normal font-merri fontcol2">
                      <p className="font-merri">{val.body.substring(0, 275) + (val.body.length > 275 ? "..." : "")}</p>
                  </div>
                </div>
                {val.image && (
          ...
          <div className="nav-btn more-button mt-2.5 font-accent"> 
            <Link className="flex font-bitcount font-navbar nav-btn-a" href="/activity">VIEW MORE</Link>
          </div>
        </div>
        ...
        <div className="section-cont content-col">
          ...
          <Link className="section-entry prefaceOride mt-2.5 mb-2" href="/info"> 
        ...
        <div className="section-cont content-col">
          ...
          <div className="nav-btn more-button mt-2.5 font-accent"> 
            <Link className="flex font-bitcount font-navbar nav-btn-a" href="/certifications">VIEW MORE</Link>
          </div>    
        </div>
        ...
        <div className="section-cont content-col">
          ...
          <div className="section-cont-row gap-Oride mt-5 wrap"> 
            {apps && (Array.isArray(apps) ? apps : Object.values(apps)).map((val, index: number) => index < 4 && ( 
          ...
          <div className="nav-btn more-button mt-2.5 font-accent"> 
            <Link className="flex font-bitcount font-navbar nav-btn-a" href="/apps">VIEW MORE</Link>
          </div>
        </div>
